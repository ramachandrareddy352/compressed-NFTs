import { createCreateTreeInstruction, MPL_BUBBLEGUM_PROGRAM_ID } from "@metaplex-foundation/mpl-bubblegum";
...
async function createTree() {
    const keypair = loadWalletKey("RCRtAxBNNtb7WAicWFBvrQm3NBRCYJzgSvuUZorThNn.json");
    const connection = new Connection("https://api.devnet.solana.com");
    const merkleTree = loadWalletKey("trEe1Gd1AcdxAEHWKjpFTiZtkdKT9YNLkf5vY3fZpgu.json");
